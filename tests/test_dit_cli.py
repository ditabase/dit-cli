...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "fail/namespace-var1.dit",
            'VarError: Undefined variable "does" in "does.not.exist"',
        ),
        ...
        (
            "fail/node-recur2.dit",
            'NodeError: Illegal recursive attribution in class "A"',
        ),
        (
            "fail/parser-class1.dit",
            'ParseError: "extends" must come first, or not at all',
        ),
        ...
        (
            "fail/parser-assign0.dit",
            "ParseError: Unexpected EOF while parsing assignment.",
        ),
        ...
        (
            "fail/parser-import2.dit",
            '''ParseError: Import failed, file not found
Path: "/not/a/real/link"''',
        ),
        (
            "fail/parser-import3.dit",
            '''ParseError: Import failed, permission denied
Path: "/root/"''',
        ),
        (
            "fail/parser-import4.dit",
            '''ParseError: Import failed, HTTP Error 500: Domain Not Found
URL: "https://notadomain.githubusercontent.com/"''',
        ),
        (
            "fail/parser-import5.dit",
            '''ParseError: Import failed, HTTP Error 404: Not Found
URL: "https://raw.githubusercontent.com/isaiahshiner/dits/master/dits/ClearlyNotADit.dit"''',
        ),
        (
            "fail/parser-import6.dit",
            """ParseError: Import failed, file is <!DOCTYPE html>.
